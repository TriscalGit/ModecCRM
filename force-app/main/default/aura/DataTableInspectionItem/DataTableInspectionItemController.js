({
    ...
    init: function (cmp, event, helper) {
        ...
        cmp.set('v.columns', [
            {label: 'Quality Receipt Inspection Item', fieldName: 'Name', type: 'text'},
            {label: 'Quantity', fieldName: 'TW5_Quantity__c', type: 'number'},
            {label: 'Status', fieldName: 'TW1_Status__c', type: 'text'}
        ]);
